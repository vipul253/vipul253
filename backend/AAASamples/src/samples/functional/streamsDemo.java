...
public class streamsDemo {
    ...
    public static void main(String[] args) {
        List<Employee> empList = Arrays.asList(
                new Employee(101, "Alice Smith", 30, 75000.0, "Manager", "Female", "QC"),
        ...
        System.out.println("============================================");
        List<Employee> top5Sal = empList.stream().sorted((a,b)-> (int) (b.getSalary()-a.getSalary()))
                .limit(5)
        ...
        System.out.println("============================================");
        Map<String, Double> expenseByDept = empList.stream().collect(Collectors.groupingBy(Employee::getDepartment,
                Collectors.summingDouble(Employee::getSalary)));
        System.out.println("total expenditure department wise:");
        System.out.println(expenseByDept);

        System.out.println("\n============================================");
        Map<String, Long> maleToFemaleCount = empList.stream().collect(Collectors.groupingBy(
        ...
        Map.Entry<String, Integer> lowestAgeDept = empList.stream()
                ...
                .orElseThrow();
        System.out.println("Youngest Department :" + lowestAgeDept.getKey() + " Total Age: " + lowestAgeDept.getValue());

        System.out.println("\n============================================");
        long totalEmpCount = empList.stream().count(); // Collection.size();
